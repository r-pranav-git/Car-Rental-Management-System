                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Registered Users List</div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?del=<?php echo htmlentities($row['userid']); ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-close"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $cnt++;
