                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($row['carName']); ?></td>
                                                <td><?php echo htmlentities($row['rateType']); ?></td>
                                                <td><?php echo htmlentities($row['name']); ?></td>
                                                <td><?php echo htmlentities($row['email']); ?></td>
                                                <td><?php echo htmlentities($row['phone']); ?></td>
                                                <td><?php echo htmlentities($row['pickupDate']); ?></td>
                                                <td><?php echo htmlentities($row['dropoffDate']); ?></td>
                                                <td><?php echo htmlentities($row['totalPayment']); ?></td>
                                                <td>
                                                    <a href="?del=<?php echo htmlentities($row['id']); ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-close"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $cnt++;
